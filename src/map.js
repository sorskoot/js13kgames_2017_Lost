var Dungeon = {
    ...
    Generate: function () {
        ...
        var room_count = 100;//Helpers.rnd(40, 80);
        var min_size = 5;
        var max_size = 25;
        for (var i = 0; i < room_count; i++) {
            var room = {};

            room.x = Helpers.rnd(1, this.map_size - max_size - 1);
            room.y = Helpers.rnd(1, this.map_size - max_size - 1);
            
            room.w = Helpers.rnd(min_size, max_size);
            room.h = Helpers.rnd(min_size, max_size);
        ...
        for (i = 0; i < room_count; i++) {
            ...
            pointA = {
                x: Helpers.rnd(roomA.x, roomA.x + roomA.w),
                y: Helpers.rnd(roomA.y, roomA.y + roomA.h)
            };
            pointB = {
                x: Helpers.rnd(roomB.x, roomB.x + roomB.w),
                y: Helpers.rnd(roomB.y, roomB.y + roomB.h)
            };
